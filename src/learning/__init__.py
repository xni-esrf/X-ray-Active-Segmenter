...
_EXPORT_MODULE_BY_NAME: Dict[str, str] = {
    ...
    "DEFAULT_INFERENCE_MINIVOL_SIZE": ".inference_geometry",
    "DEFAULT_INFERENCE_STRIDE": ".inference_geometry",
    "DEFAULT_LARGE_CROP_EDGE_VOXELS": ".inference_geometry",
    "DEFAULT_LARGE_CROP_VOXEL_BUDGET": ".inference_geometry",
    "INFERENCE_CROP_EXTENT_OVERLAP": ".inference_geometry",
    "INFERENCE_INTERNAL_CROP_DISCARD_MARGIN": ".inference_geometry",
    "coerce_inference_minivol_size": ".inference_geometry",
    "inference_crop_extent_overlap_for_minivol_size": ".inference_geometry",
    "inference_internal_crop_discard_margin_for_minivol_size": ".inference_geometry",
    "inference_stride_for_minivol_size": ".inference_geometry",
    "inference_valid_step_for_crop_size": ".inference_geometry",
    "CropExtractionPlan": ".large_crop_inference_plan",
    "LargeCropInferencePlan": ".large_crop_inference_plan",
    "LargeCropWindow": ".large_crop_inference_plan",
    "build_large_crop_inference_plan": ".large_crop_inference_plan",
    "extract_large_crop_from_array": ".large_crop_extraction",
    "extract_large_crop_from_volume": ".large_crop_extraction",
    "LargeCropInferenceResult": ".large_crop_inference",
    "OneCropLargeCropInferenceResult": ".large_crop_inference",
    "run_large_crop_inference_to_zarr": ".large_crop_inference",
    "run_one_crop_large_crop_inference_to_zarr": ".large_crop_inference",
    "LargeCropZarrOutputWriter": ".large_crop_zarr_writer",
    "create_large_crop_zarr_output_writer": ".large_crop_zarr_writer",
