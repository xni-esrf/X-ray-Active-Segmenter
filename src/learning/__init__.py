...
_EXPORT_MODULE_BY_NAME: Dict[str, str] = {
    ...
    "MinivolCell": ".streaming_inference_plan",
    "MinivolExtractionPlan": ".streaming_inference_plan",
    "OutputBlock": ".streaming_inference_plan",
    "OutputChunk": ".streaming_inference_plan",
    "StreamingInferencePlan": ".streaming_inference_plan",
    "build_streaming_inference_plan": ".streaming_inference_plan",
    "OccupancyStatsScan": ".zero_occupancy",
    "StreamingNormalizationStats": ".zero_occupancy",
    "StreamingPrePassResult": ".zero_occupancy",
    "compute_streaming_normalization_stats": ".zero_occupancy",
    "prepare_streaming_occupancy_and_stats": ".zero_occupancy",
    "scan_occupancy_and_intensity": ".zero_occupancy",
    "StreamingInferenceResult": ".streaming_inference",
    "StreamingInferenceStopRequested": ".streaming_inference",
    "build_torch_minivol_forward": ".streaming_inference",
    "run_streaming_inference": ".streaming_inference",
    "StreamingZarrWriter": ".streaming_zarr_writer",
    "create_streaming_zarr_writer": ".streaming_zarr_writer",
