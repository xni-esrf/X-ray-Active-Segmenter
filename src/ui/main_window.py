...
class MainWindow(QMainWindow):
    def __init__(
        ...
        *,
        ...
        layout.addWidget(self.views["sagittal"], 1, 0)
        self._unused_view = QWidget()
        self._unused_view.setObjectName("unused_view")
        self._unused_view.setStyleSheet("#unused_view { background-color: black; }")
        self._unused_view.setAttribute(Qt.WA_TransparentForMouseEvents, True)
        self._unused_view.setFocusPolicy(Qt.NoFocus)
        layout.addWidget(self._unused_view, 1, 1)
